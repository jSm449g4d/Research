...
def train():
    ...
    model.save('modelVdsr.h5')
    
def test():
    model = keras.models.load_model('modelVdsr.h5')
    os.makedirs(os.path.join("./", 'outVdsr'),exist_ok=True)
    ...
    for i,testX in enumerate(dataset):
        ...
        tf2img(predY,os.path.join("./", 'outVdsr'),name=str(i).zfill(8))
