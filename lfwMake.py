...
os.makedirs("./lfw_learn/train_y",exist_ok=True)
os.makedirs("./lfw_learn/train_4",exist_ok=True)
os.makedirs("./lfw_learn/train_Up4",exist_ok=True)
os.makedirs("./lfw_learn/train_normal",exist_ok=True)
os.makedirs("./lfw_learn/train_fail",exist_ok=True)
os.makedirs("./lfw_learn/train_nf",exist_ok=True)
os.makedirs("./lfw_learn/train_canny",exist_ok=True)
os.makedirs("./lfw_learn/train_cubic4",exist_ok=True)
os.makedirs("./lfw_learn/test_y",exist_ok=True)
os.makedirs("./lfw_learn/test_4",exist_ok=True)
os.makedirs("./lfw_learn/test_Up4",exist_ok=True)
os.makedirs("./lfw_learn/test_normal",exist_ok=True)
os.makedirs("./lfw_learn/test_fail",exist_ok=True)
os.makedirs("./lfw_learn/test_nf",exist_ok=True)
os.makedirs("./lfw_learn/test_canny",exist_ok=True)
os.makedirs("./lfw_learn/test_cubic4",exist_ok=True)
...
for i,dirs in enumerate(lfw):
    img=cv2.imread(dirs)
    outputfolder="./lfw_learn/train_"
    if i>sample:
        outputfolder="./lfw_learn/test_"        
    ...
    cv2.circle(img_fail, (random.randrange(0, dSize), random.randrange(0, dSize)),
               random.randrange(int(dSize//6), int(dSize//3)), (0, 0, 0),-1)
    img_normal=img_fail+np.random.normal(0, 64, (dSize, dSize,3))
    img_normal=(np.clip(img_normal,0,255)).astype(np.uint8)
    cv2.imwrite(outputfolder+"nf/"+str(i)+".png",
                cv2.resize(img_normal, dsize=(dSize, dSize)))
