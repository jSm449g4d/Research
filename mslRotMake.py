...
os.makedirs("./msl_srlearn/train_y",exist_ok=True)
os.makedirs("./msl_srlearn/train_4",exist_ok=True)
os.makedirs("./msl_srlearn/train_cubic4",exist_ok=True)
os.makedirs("./msl_srlearn/train_normal",exist_ok=True)
os.makedirs("./msl_srlearn/train_median",exist_ok=True)
os.makedirs("./msl_srlearn/train_gaussb",exist_ok=True)
os.makedirs("./msl_srlearn/train_bilatr",exist_ok=True)
os.makedirs("./msl_srlearn/test_y",exist_ok=True)
os.makedirs("./msl_srlearn/test_4",exist_ok=True)
os.makedirs("./msl_srlearn/test_cubic4",exist_ok=True)
os.makedirs("./msl_srlearn/test_normal",exist_ok=True)
os.makedirs("./msl_srlearn/test_median",exist_ok=True)
os.makedirs("./msl_srlearn/test_gaussb",exist_ok=True)
os.makedirs("./msl_srlearn/test_bilatr",exist_ok=True)

lfw=ffzk("./msl")[100:]
sample=10000
outputfolder="./msl_srlearn/train_"
#lfw=ffzk("./msl")[:100]
#sample=1000
