...
parser.add_argument('-ti', '--train_input' ,default="./datasets/mls_srlearn/train_cubic8")
parser.add_argument('-to', '--train_output' ,default="./datasets/mls_srlearn/train_y")
parser.add_argument('-pi', '--pred_input' ,default='./datasets/mls_srlearn/test_cubic8')
parser.add_argument('-po', '--pred_output' ,default='./datasets/mls_srlearn/test_y')
