...
劣化部分画像{\it x}と部分画像{\it y}の比較評価にはPSNRとSSIMを使用した.
...
図において,左のU-Netの構造,真ん中のSRCNNの構造,右の迂回路によって構成した.
...
迂回路を設けることで,機械学習モデルの積層やDropoutによる元画像の情報の劣化を防ぐことが出来た.
...
学習に使用する部分画像のサンプル数$ n $は10000,1000,100の3パターンで行った.
