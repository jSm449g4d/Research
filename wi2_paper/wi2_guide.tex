...
高品質化のアプローチ一つに，超解像(Super resolution)と呼ばれる解像度の低いデータを高解像化するものがある.
深層学習による超解像の例として，月面DEMの高解像度化\cite{bib5}や深海海底地形図の作成\cite{bib6}，CTやMRI画像の超解像\cite{bib7}がある.
...
\bibitem{bib99} 伊藤喜代志: 機械学習による超解像技術を活用した詳細な深海海底地形図の作成, 日本水産工学会誌 , Vol.56, No.1, p47-50, 2019
